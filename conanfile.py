...
class CrossSpeciesComparisonPhyTVuPluginConan(ConanFile):
    """Class to package CrossSpeciesComparisonPhyTVuPlugin using conan
    ...
    scm = {"type": "git", "subfolder": "mv/CrossSpeciesComparisonPhyTVuPlugin", "url": "auto", "revision": "auto"}
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="mv/CrossSpeciesComparisonPhyTVuPlugin")
        cmake.verbose = True
        return cmake
    ...
    def build(self):
        ...
        # The CrossSpeciesComparisonPhyTVuPlugin plugins expect the MV package to be in this install dir
